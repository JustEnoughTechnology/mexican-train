...
var test_scenes = {
	"Complete Game": "res://scenes/test/mexican_train_complete_test.tscn",
	"Station + Train": "res://scenes/test/train_station_drag_drop_test.tscn", 
	"Boneyard + Hand": "res://scenes/test/boneyard_hand_drag_drop_test.tscn",
	"Hand Only": "res://scenes/test/hand_drag_drop_test.tscn",
	"Train Only": "res://scenes/test/train_drag_drop_test.tscn",
	"Station Only": "res://scenes/test/station_only_test.tscn",
	"Boneyard Only": "res://scenes/test/bone_yard_test.tscn"
}
